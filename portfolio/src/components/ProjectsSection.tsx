  ...
  return (
    <section id="projects" className="py-12 sm:py-16 lg:py-20 relative">
      <div className="max-w-6xl mx-auto px-4">
        ...
        {/* Featured Projects */}
        <motion.div
          className="space-y-8 sm:space-y-12 lg:space-y-16 mb-12 sm:mb-16 lg:mb-20"
          ...
          {featuredProjects.map((project, index) => (
            ...
            >
              ...
              <div className="flex-1 w-full">
                ...
                >
                  <div className="text-white text-4xl sm:text-6xl lg:text-8xl opacity-30">
                    <svg fill="currentColor" viewBox="0 0 20 20" className="w-12 h-12 sm:w-16 sm:h-16 lg:w-20 lg:h-20">
              ...
              <div className="flex-1 space-y-3 sm:space-y-4">
                ...
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-3 sm:pt-4">
                  <motion.a
                    ...
                    className="px-4 sm:px-6 py-2 sm:py-3 bg-blue-500 hover:bg-blue-600 text-white rounded-lg transition-colors duration-200 font-medium text-sm sm:text-base text-center"
                  ...
                  <motion.a
                    ...
                    className="px-4 sm:px-6 py-2 sm:py-3 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-lg transition-colors duration-200 font-medium text-sm sm:text-base text-center"
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                  >
                    {t('projects.viewCode')}
        ...
        <motion.div
          ...
          transition={{ duration: 0.8 }}
        >
          <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-800 dark:text-white text-center mb-8 sm:mb-12">
          ...
          >
            {otherProjects.map((project) => (
              <motion.div
                key={project.id}
                className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4 sm:p-6 shadow-md hover:shadow-lg transition-shadow duration-300"
                variants={itemVariants}
                whileHover={{ y: -5 }}
              >
