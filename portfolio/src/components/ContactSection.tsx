  ...
  const contactMethods = [
    {
      ...
      title: "Email",
      value: "hung.dev@example.com",
      href: "mailto:hung.dev@example.com",
    ...
    },
    {
      ...
      title: "LinkedIn",
      value: "linkedin.com/in/hung",
      href: "https://linkedin.com/in/hung",
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        >
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            I'm always interested in new opportunities and collaborations. Let's discuss how we can create something amazing together!
          </p>
        </motion.div>
              ...
              <div className="flex space-x-4">
                {contactMethods.filter(method => ['Twitter', 'LinkedIn'].includes(method.title)).map((social, index) => (
                  <motion.a
                    ...
                    className="w-10 h-10 bg-gray-200 dark:bg-gray-700 rounded-full flex items-center justify-center text-gray-600 dark:text-gray-400 hover:bg-blue-500 hover:text-white transition-colors duration-200"
