...
const ContactSection = () => {
  ...
  const contactMethods: ContactMethod[] = [
    ...
    },
    {
      ...
      title: t('contact.contactMethods.twitter.title'),
      value: t('contact.contactMethods.twitter.value'),
      href: t('contact.contactMethods.twitter.href'),
      description: t('contact.contactMethods.twitter.description')
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
